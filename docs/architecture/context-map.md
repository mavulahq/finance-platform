...
- O audit trail registra ações atuais. A Fase 2 introduz o primeiro vertical slice de domain events com `lending.loan_disbursed`; os demais eventos continuam propostos até terem implementação equivalente.
