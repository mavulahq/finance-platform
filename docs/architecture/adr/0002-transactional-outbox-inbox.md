...
- A Fase 2 define tabelas, leasing, publisher, Inbox e recuperação de falhas inicialmente para os eventos Lending ativos: `lending.loan_disbursed` e `lending.payment_posted`.
