...
- ✅ RFC-0001 Phase 2 has active Product Configuration and Lending vertical slices for `products.configuration_published`, `lending.loan_disbursed`, and `lending.payment_posted`: payload schemas, Outbox producers, BullMQ transport adapter, Inbox consumer, and tests.
