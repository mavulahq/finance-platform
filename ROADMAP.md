...
- ✅ RFC-0001 Phase 2 has active Lending vertical slices for `lending.loan_disbursed` and `lending.payment_posted`: payload schemas, Outbox producers, BullMQ transport adapter, Inbox consumer, and tests.
